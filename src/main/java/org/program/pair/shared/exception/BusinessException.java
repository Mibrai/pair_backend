...
public class BusinessException extends RuntimeException implements HasErrorCode {
     ...
     * {@link #BusinessException(ErrorCode, String)}, ou le constructeur à {@code messageKey}
     ...
     */
    public BusinessException(ErrorCode errorCode, String messageKey, String message) {
