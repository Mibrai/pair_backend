-- =================================================================
-- SQLHistory - Complete Database Setup (Without Embedding)
-- =================================================================
-- Temporary solution: creates tables without pgvector embedding column
-- =================================================================

-- Enable extensions (pgvector will be added later in Phase 2)
...
\echo '=== Creating Activities Table (without embedding) ==='
...
\echo '  - activities (12 rows) - NOTE: embedding column will be added in Phase 2'
